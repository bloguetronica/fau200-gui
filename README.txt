This package contains all the necessary files and scripts to install FAU200
GUI (which is a graphical user interface that invokes commands to control the
FAU200 Power Supply). The scripts included here are compatible with most
...
packages "fau200-1.1.tar.gz" or "fau200-1.0.tar.gz" to do so).

A list of the included scripts follows:
– install.sh;
– uninstall.sh.

In order to compile and install FAU200 GUI for the first time, all you have to
